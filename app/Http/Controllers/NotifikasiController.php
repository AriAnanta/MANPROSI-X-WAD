...
class NotifikasiController extends Controller
{
    ...
    public function requestCredit(Request $request)
    {
        ...
        $requestCredit = RequestCarbonCredit::create([
            'kategori_emisi' => $validated['kategori_emisi'],
            'sub_kategori' => $validated['sub_kategori'],
            'jumlah_kredit' => $validated['jumlah_kredit'],
        ...
        Notification::create([
            'title' => 'Request Pembelian Carbon Credit Baru',
            'message' => "Request pembelian carbon credit untuk kategori {$validated['kategori_emisi']} - {$validated['sub_kategori']} sebesar {$validated['jumlah_kredit']} ton CO₂e",
            'type' => 'request_credit',
            'priority' => $validated['prioritas'],
            'status' => 'unread',
            'data' => json_encode([
                'request_id' => $requestCredit->id,
