                                ...
                                <tbody>
                                    @forelse($carbon_credits as $credit)
                                        <tr class="credit-row" 
                                            ...
                                            <td>{{ $credit->penyediaCarbonCredit->nama_penyedia }}</td>
                                            <td>{{ number_format($credit->jumlah_kompensasi, 0) }}</td>
                                            <td>{{ $credit->penyediaCarbonCredit->mata_uang }} {{ number_format($credit->total_harga, 2) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
