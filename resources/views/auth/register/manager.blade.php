...
<head>
    ...
    <title>Register Manager - GreenLedger</title>
    ...
    <div class="register-container">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="text-white mb-0">Register Manager</h5>
            </div>
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('register.manager') }}">
                    ...
                    <div class="mb-3">
                        <label for="nama_manager" class="form-label">Nama Lengkap</label>
                        <input type="text" class="form-control @error('nama_manager') is-invalid @enderror" 
                               name="nama_manager" value="{{ old('nama_manager') }}" required autofocus>
                    </div>
